...
public class UserRegistry {
  ...
  public void register(UserSession user) {
    ...
    usersBySessionId.put(user.getSession(), user);
  }
  ...
  public UserSession getBySession(String session) {
    return usersBySessionId.get(session);
  }
  ...
  public UserSession removeBySession(String session) {
    final UserSession user = getBySession(session);
    if (user != null) {
      usersByName.remove(user.getName());
      usersBySessionId.remove(session);
    }
    return user;
  }
