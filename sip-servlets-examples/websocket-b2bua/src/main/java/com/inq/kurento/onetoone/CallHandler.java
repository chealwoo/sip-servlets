...
package com.inq.kurento.onetoone;
...
public class CallHandler {
  ...
  public void handleTextMessage(String session, JsonObject jsonMessage) throws Exception {
  ...
  private void handleErrorResponse(Throwable throwable, String session, String responseId)
      throws IOException {
//    stop(session);
...
//    session.sendMessage(new TextMessage(response.toString()));
  ...
  private void register(String session, JsonObject jsonMessage) throws IOException {
...
//                } catch (IOException e) {
  ...
  public void stop(String session) throws IOException {
  ...
  public void afterConnectionClosed(String session) throws Exception {
    stop(session);
